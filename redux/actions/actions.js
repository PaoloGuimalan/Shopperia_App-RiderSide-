import { SET_DELIVERED, SET_INBOX, SET_MESSAGES, SET_RETRIEVED, SET_RIDER_BRANCH, SET_RIDER_ID, SET_SERVER, SET_TO_DELIVER, SET_TO_RETRIEVE } from "../types/types"; 
...
export const setretrieved = (state = [], action) => {
    switch(action.type){
        case SET_RETRIEVED:
...
export const setdelivered = (state = [], action) => {
    switch(action.type){
        case SET_DELIVERED:
